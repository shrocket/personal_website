...
(function () {
			const buttonExperience = document.querySelector('[data-js="buttonWorkExperience"]');
			const expandExperience = document.querySelector('[data-js="moreWorkExperience"]');
			if (buttonExperience && expandExperience) {
				buttonExperience.addEventListener("click", () => {
					expandExperience.classList.toggle("work-experience--more");
					buttonExperience.textContent = expandExperience.classList.contains("work-experience--more") ? "more" : "less";
				});
			}
			...
			if (buttonTeaching && expandTeaching) {
				buttonTeaching.addEventListener("click", () => {
					expandTeaching.classList.toggle("teaching--more");
					buttonTeaching.textContent = expandTeaching.classList.contains("teaching--more") ? "more" : "less";
				});
			}
		})();