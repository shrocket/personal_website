...
\[To see this post in its original context, click [here](2013-11-27-what-i-can-hear-behind-siris-voices.md).\]
...
Do we think these things are not somehow expressed in the code that runs the things that run our lives? The number of simple traffic warning displays that have been hacked to read _zombies ahead_ or _you're going to be late_, and that we even know what easter eggs are, let alone are able to go looking for them should indicate the degree to which dissatisfaction and a kind of general powerlessness is part of everyone's subconscious, is part of programmers' subconsciousnesses.
